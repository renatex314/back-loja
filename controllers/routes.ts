...
/***    MÉTODO PAGAMENTO   ***/
/*****************************/
router.get('/metodopagamento/dropdown', metpagController.getMetodoPagamentoDropdown);
router.post('/metodopagamento/create', metpagController.createMetodoPagamento);
router.delete('/metodopagamento/delete/:metPagId', metpagController.deleteMetodoPagamento);
